...
public class ayuda extends javax.swing.JFrame {
    ...
    public ayuda() {
        ...
        text.setText("     --- BIENVENIDOS AL SIMULADOR DE ASIGNACIÓN ---\n"
                   + "     --- DE MEMORIA Y PLANIFICACIÓN DE PROCESOS --- \n"
                + "\n"
                + "CONSIDERACIONES:\n"
                + "*La carga se realiza por medio de un archivo Excel llamado\n"
                + " 'Procesos' el cual se aloja en la carpeta principal del\n"
                + "programa.\n"
                + "\n"
                + "*Predeterminadamente se agregan 10 procesos a modo \n"
                + " de ejemplo. \n"
                + "\n"
                + "*Si quiero eliminarlos debo borrarlos en el archivo Excel,\n"
                + "guardar el archivo y volver a ejecutar el simulador.\n"
                + "\n"
                + "*Para que funcione el simulador debo seleccionar con  \n"
                + "el MOUSE en el texto 'EMPEZAR' y luego presionar la \n"
                + "tecla 'ESPACIO' para ir avanzando cada instante de tiempo.\n"
                + "\n"
                + "*SE RECOMIENDA DEJAR EN LA RUTA 'POR DEFECTO' \n"
                + "PARA QUE FUNCIONE CORRECTAMENTE EL SIMULADOR.");
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 360, 180));
